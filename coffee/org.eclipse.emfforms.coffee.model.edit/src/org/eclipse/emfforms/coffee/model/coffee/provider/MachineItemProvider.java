...
public class MachineItemProvider extends ComponentItemProvider {
	...
	protected void addModelNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
			.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
				getResourceLocator(),
				getString("_UI_Machine_modelName_feature"), //$NON-NLS-1$
				getString("_UI_PropertyDescriptor_description", "_UI_Machine_modelName_feature", "_UI_Machine_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				CoffeePackage.Literals.MACHINE__MODEL_NAME,
				true,
				false,
				false,
	...
	public String getText(Object object) {
		final String label = ((Machine) object).getModelName();
