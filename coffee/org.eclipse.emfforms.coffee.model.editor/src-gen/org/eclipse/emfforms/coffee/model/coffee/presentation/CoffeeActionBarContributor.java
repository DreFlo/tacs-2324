...
public class CoffeeActionBarContributor extends EditingDomainActionBarContributor implements ISelectionChangedListener {
	...
	protected IAction showPropertiesViewAction = new Action(
			CoffeeEditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item")) //$NON-NLS-1$
	{
		@Override
		public void run() {
			try {
	...
	protected IAction refreshViewerAction = new Action(
			CoffeeEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item")) //$NON-NLS-1$
	{
		@Override
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		...
		toolBarManager.add(new Separator("coffee-settings")); //$NON-NLS-1$
		toolBarManager.add(new Separator("coffee-additions")); //$NON-NLS-1$
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(CoffeeEditorPlugin.INSTANCE.getString("_UI_CoffeeEditor_menu"), //$NON-NLS-1$
				"org.eclipse.emfforms.coffee.model.coffeeMenuID"); //$NON-NLS-1$
		...
		//
		createChildMenuManager = new MenuManager(CoffeeEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item")); //$NON-NLS-1$
		submenuManager.insertBefore("additions", createChildMenuManager); //$NON-NLS-1$

		// Prepare for CreateSibling item addition or removal.
		//
		createSiblingMenuManager = new MenuManager(
				CoffeeEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item")); //$NON-NLS-1$
	...
	public void menuAboutToShow(IMenuManager menuManager) {
		...
		submenuManager = new MenuManager(CoffeeEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item")); //$NON-NLS-1$
		populateManager(submenuManager, createChildActions, null);
		menuManager.insertBefore("edit", submenuManager); //$NON-NLS-1$

		submenuManager = new MenuManager(CoffeeEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item")); //$NON-NLS-1$
