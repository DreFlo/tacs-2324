...
public class CourseItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 UniversityPackage.Literals.COURSE__CREDITS,
				 true,
				 false,
				 false,
	...
	protected void addDegreesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Course_degrees_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Course_degrees_feature", "_UI_Course_type"),
				 UniversityPackage.Literals.COURSE__DEGREES,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(UniversityPackage.Literals.COURSE__EDITIONS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(UniversityPackage.Literals.COURSE__EDITIONS,
				 UniversityFactory.eINSTANCE.createEdition()));
	}
