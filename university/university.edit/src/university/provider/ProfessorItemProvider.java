...
public class ProfessorItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Professor_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Professor_name_feature", "_UI_Professor_type"),
				 UniversityPackage.Literals.PROFESSOR__NAME,
				 true,
				 false,
				 false,
	...
	protected void addBirthdatePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Professor_birthdate_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Professor_birthdate_feature", "_UI_Professor_type"),
				 UniversityPackage.Literals.PROFESSOR__BIRTHDATE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Professor.class)) {
			...
			case UniversityPackage.PROFESSOR__BIRTHDATE:
