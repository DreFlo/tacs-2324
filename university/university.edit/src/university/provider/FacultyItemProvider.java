...
public class FacultyItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 UniversityPackage.Literals.FACULTY__NAME,
				 true,
				 false,
				 false,
	...
	protected void addDegreesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Faculty_degrees_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Faculty_degrees_feature", "_UI_Faculty_type"),
				 UniversityPackage.Literals.FACULTY__DEGREES,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(UniversityPackage.Literals.FACULTY__PROFESSORS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(UniversityPackage.Literals.FACULTY__PROFESSORS,
				 UniversityFactory.eINSTANCE.createProfessor()));
	}
