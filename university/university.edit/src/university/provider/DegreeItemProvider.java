...
/**
 * This is the item provider adapter for a {@link university.Degree} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
	...
	protected void addCoursesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Degree_courses_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Degree_courses_feature", "_UI_Degree_type"),
				 UniversityPackage.Literals.DEGREE__COURSES,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addStudentsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Degree_students_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Degree_students_feature", "_UI_Degree_type"),
				 UniversityPackage.Literals.DEGREE__STUDENTS,
				 true,
				 false,
				 true,
				 null,
