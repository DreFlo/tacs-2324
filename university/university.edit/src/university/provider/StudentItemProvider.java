...
public class StudentItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 UniversityPackage.Literals.STUDENT__NAME,
				 true,
				 false,
				 false,
	...
	protected void addBirthdatePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Student_birthdate_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Student_birthdate_feature", "_UI_Student_type"),
				 UniversityPackage.Literals.STUDENT__BIRTHDATE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(UniversityPackage.Literals.STUDENT__GRADES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(UniversityPackage.Literals.STUDENT__GRADES,
				 UniversityFactory.eINSTANCE.createGrade()));
	}
