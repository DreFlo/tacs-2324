...
public class UniversityPackageImpl extends EPackageImpl implements UniversityPackage {
	 ...
	 */
	@Override
	public EReference getFaculty_Degrees() {
	 ...
	 */
	@Override
	public EReference getDegree_Courses() {
		return (EReference)degreeEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 */
	@Override
	public EReference getCourse_Degrees() {
	 ...
	 */
	@Override
	public EReference getEdition_Grades() {
	 ...
	 */
	@Override
	public EReference getStudent_Grades() {
	...
	public void createPackageContents() {
		...
		createEReference(facultyEClass, FACULTY__DEGREES);
		...
		createEReference(courseEClass, COURSE__DEGREES);
		...
		createEReference(editionEClass, EDITION__GRADES);
	...
	public void initializePackageContents() {
		...
		initEReference(getFaculty_Degrees(), this.getDegree(), null, "degrees", null, 0, -1, Faculty.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getCourse_Editions(), this.getEdition(), null, "editions", null, 0, -1, Course.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getCourse_Degrees(), this.getDegree(), this.getDegree_Courses(), "degrees", null, 0, -1, Course.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getProfessor_Birthdate(), ecorePackage.getEDate(), "birthdate", null, 0, 1, Professor.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
