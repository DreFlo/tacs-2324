 ...
 *   <li>{@link university.impl.ProfessorImpl#getBirthdate <em>Birthdate</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ProfessorImpl extends MinimalEObjectImpl.Container implements Professor {
	...
	public void setBirthdate(Date newBirthdate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UniversityPackage.PROFESSOR__BIRTHDATE, oldBirthdate, birthdate));
	}
